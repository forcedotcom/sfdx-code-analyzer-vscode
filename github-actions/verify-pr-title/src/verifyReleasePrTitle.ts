 ...
 * i.e. a PR aimed at the {@code main} branch.
 */
const RELEASE_PR_REGEX = new RegExp(
    `^${PR_TYPE_PORTION}${SEPARATOR}${WORK_ITEM_PORTION}${SEPARATOR}.+`,
    'i'
);

/**
 * Verifies that the provided string is an acceptable title for a PR
 * aimed at the {@code main} branch.
 */
