...
describe('AgentforceCodeActionProvider Tests', () => {
    ...
    describe('provideCodeActions Tests', () => {
        ...
        const supportedDiag2: vscode.Diagnostic = createSampleCodeAnalyzerDiagnostic(sampleUri, compatibleRange, 'AvoidHardcodingId');
        const supportedDiag3: vscode.Diagnostic = createSampleCodeAnalyzerDiagnostic(sampleUri, compatibleRange, 'EmptyWhileStmt');
