...
describe('AgentforceCodeActionProvider Tests', () => {
    ...
    describe('provideCodeActions Tests', () => {
        ...
        const supportedDiag2: vscode.Diagnostic = createSampleCodeAnalyzerDiagnostic(sampleUri, compatibleRange1, 'AvoidHardcodingId');
        const supportedDiag3: vscode.Diagnostic = createSampleCodeAnalyzerDiagnostic(sampleUri, compatibleRange2, 'EmptyWhileStmt');
