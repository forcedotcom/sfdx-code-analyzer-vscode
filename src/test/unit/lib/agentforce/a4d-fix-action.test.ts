...
describe('Tests for A4DFixAction', () => {
    ...
    describe('Robust JSON parsing tests', () => {
        ...
        it('When llm response has extra text before JSON (like "apist" example), then fix is suggested successfully', async () => {
        ...
        it('When llm response has extra text after JSON, then fix is suggested successfully', async () => {
            spyLLMService.callLLMReturnValue = '{"fixedCode": "test code", "explanation": "test explanation"}\nsome extra text here';
        ...
        it('When llm response is JSON wrapped in single quotes and markdown (second example), then fix is suggested successfully', async () => {
        ...
        it('When llm response has no valid JSON at all, then display error message and send exception telemetry event', async () => {
            spyLLMService.callLLMReturnValue = 'This is just plain text with no JSON at all';
        ...
        it('When llm response has JSON that is malformed beyond repair, then display error message and send exception telemetry event', async () => {
            spyLLMService.callLLMReturnValue = '{"fixedCode": "test code", "explanation": "missing closing quote and brace';
